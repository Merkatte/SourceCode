...
public class cards3: MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
{
    Shuffle shuffled;
    ...
    void IEndDragHandler.OnEndDrag(PointerEventData eventData)
    {
        ...
        if (chkObj.tile_chk == true)
        {
            ...
            if (heron_tile.on_tile == false && gameManager.isGoldEnough(card_Loader.Loaded_Info[0].cost))
            {
                soundManager.playSound("Card_Put");
                GameObject instance = objectManager.MakeObj("ChainSaw_Hero");
                ...
                hero = instance.GetComponent<ChainSaw_Hero_Movement>();
                hero.hp = hp;
